...
class _AddNewCareState extends State<AddNewCare> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CareBloc, CareState>(listener: (context, state) {
      if (state.isCreated) {
        NotiBar.showSnackBar(context, 'Thêm thành công!',
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                onChanged: (value) {
                                  if (value.isNotEmpty) {
                                    DateTime careNextDate =
                                        generateCareNextDate(_date,
                                            dropDownRoutine, int.parse(value));
                                    careNextTimeController.text =
                                        '${DateFormat('dd/MM/yyyy').format(careNextDate)} ${_time.format(context)}';
                                  }
                                },
